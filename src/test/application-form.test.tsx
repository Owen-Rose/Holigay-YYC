...
describe('VendorApplicationForm', () => {
  ...
  describe('Validation', () => {
    ...
    it('shows error when no product category is selected', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/please select at least one product category/i)).toBeInTheDocument()
      })
  ...
  describe('Form Submission', () => {
    ...
    it('includes optional fields when provided', async () => {
      ...
      await user.type(screen.getByLabelText(/business description/i), 'Handmade pottery and crafts')

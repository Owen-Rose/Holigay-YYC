export default function TemplateDetailLoading() {
  return (
    <div>
      ...
      <div className="border-border-subtle bg-surface mt-6 space-y-4 rounded-lg border p-6">
        <div className="h-5 w-24 animate-pulse rounded bg-gray-700" />
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="bg-surface-bright space-y-3 rounded-lg border border-gray-700 p-4"
          >
